...
const FAQSection = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center relative px-8 lg:px-16 xl:px-32 pt-[64px] pb-[120px] gap-16">
      <h2 className="font-extrabold font-romaben text-black text-9xl tracking-tighter text-start self-start">
        FAQ
      </h2>
